...
def generate_integration_report(backup_status, math_status, trading_status, backtest_status):
    ...
    overall_percentage = (working_components / total_components * 100) if total_components > 0 else 0
    overall_icon = "🎉" if overall_percentage >= 80 else "⚠️" if overall_percentage >= 50 else "💥"
    ...
    if overall_percentage >= 80:
        print("   🎉 System is well integrated! Minor fixes needed for optimal performance.")
    elif overall_percentage >= 50:
        print("   ⚠️  System needs attention. Address missing components for better functionality.")
    else:
...
def main():
    ...
    # Generate report
    overall_score = generate_integration_report(backup_status, math_status, trading_status, backtest_status)
