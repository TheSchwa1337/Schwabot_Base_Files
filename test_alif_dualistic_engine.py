...
def create_market_data(
    ...
    market_data = {
        "current_price": price,
        "previous_price": price * (1 + random.uniform(-0.02, 0.02)),
        "volume": volume,
        ...
        "moving_average": price * random.uniform(0.98, 1.02),
...
def test_alif_state_activation():
    ...
    scenarios = [
        ("High AI Confidence", create_market_data(
            price=50000.0,
            rsi=30.0,
            volatility=0.8,
            momentum=0.1,
        ...
        ("High Volume", create_market_data(
            price=50000.0,
            volume=2000000.0,
            rsi=70.0,
            volatility=0.6,
        ...
        ("Error Correction", create_market_data(
            price=50000.0,
            rsi=50.0,
            volatility=0.4,
            include_ai_feedback=True,
...
def test_alif_memory_and_learning():
    ...
    # Add some errors
    engine.add_alif_error({
        "severity": 0.3,
        "message": "Test error for learning"
    })
...
def test_alif_performance_metrics():
    ...
    scenarios = [
        ("Bullish", create_market_data(price=50000.0, rsi=30.0, momentum=0.05)),
        ("Bearish", create_market_data(price=50000.0, rsi=70.0, momentum=-0.05)),
