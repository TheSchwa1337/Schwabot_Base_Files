...
class TradingSession:
    ...
    def _update_portfolio(self, trade: Dict[str, Any]):
        ...
        if trade['side'] == 'BUY':
            ...
            new_avg_price = ((pos['quantity'] * pos['avg_price']) + 
...
def launch_visualizer():
    ...
    try:
        ...
        if success:
            ...
            return jsonify({
                'success': False,
                'error': f'Failed to launch visualizer: {visualizer_id}'
            })
...
def stop_visualizer():
    ...
    try:
        ...
        return jsonify({
            'success': success,
            'message': f'Stopped visualizer: {visualizer_id}' if success else f'Visualizer not running: {visualizer_id}'
        })
