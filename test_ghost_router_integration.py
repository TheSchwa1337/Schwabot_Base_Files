...
def main():
    ...
    try:
        ...
        print("   • BALT pattern retrace: sim(G_t, G_τ) + sim(Φ_t, Φ_τ) + sim(Ψ_t, Ψ_τ) > ε_threshold ✓")
        print("   • ALEPH trust evaluation: A_Trust(t) = sim(G_t, G_{t-n}) + NCCO_stability - Phase_dissonance ✓")
