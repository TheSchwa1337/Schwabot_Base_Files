...
class CleanStrategyIntegrationBridge:
    ...
    def _determine_signal_type(self, mathematical_score: float, tensor_score: float,
    ...
    def _create_strategy_signal(self, strategy_name: str, signal_analysis: Dict[str, Any],
    ...
    def _create_strategy_orchestration(self, signals: List[StrategySignal],
