...
class UnifiedMarketDataIntegrationService:
    ...
    def _notify_signal_callbacks(self, event_type: str, data: Any):
    ...
    def _notify_portfolio_callbacks(self, event_type: str, data: Any, metadata: Dict[str, Any] = None):
    ...
    def _notify_risk_callbacks(self, event_type: str, data: Any):
    ...
    def _notify_trade_callbacks(self, event_type: str, data: Any):
