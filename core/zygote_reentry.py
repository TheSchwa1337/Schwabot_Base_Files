...
class ZygoteReentrySystem:
    ...
    def __init__(self, decay_constant: float = 0.05, profit_threshold: float = 0.01):
...
if __name__ == "__main__":
    zygote_system = ZygoteReentrySystem(decay_constant=0.1, profit_threshold=0.005)

    # Add some profitable states over time
    print("Adding profitable states...")
    time.sleep(0.5)
    zygote_system.add_profitable_state(profit=0.02, weight=1.5)
    time.sleep(0.5)
    zygote_system.add_profitable_state(profit=0.003, weight=0.8) # Below threshold
    time.sleep(0.5)
    zygote_system.add_profitable_state(profit=0.015, weight=1.2)
    time.sleep(0.5)
    zygote_system.add_profitable_state(profit=0.05, weight=2.0)
    ...
    time.sleep(0.5)
    zygote_system.add_profitable_state(profit=0.001, weight=0.3)
    time.sleep(0.5)
    zygote_system.add_profitable_state(profit=0.03, weight=1.8)
