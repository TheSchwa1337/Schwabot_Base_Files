...
class ProfitEchoCache:
    ...
    def __init__(self, path: str = "data/profit_echo.json", config: Optional[Dict[str, Any]] = None):
        """
    ...
    def _calculate_confidence_score(self, profit: float, tensor_score: float, 
