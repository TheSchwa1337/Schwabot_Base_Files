...
class SchwafitOverfittingPrevention:
    ...
    def apply_schwafit_correction(self, signals: List[Dict[str, Any]], 
    ...
    def _calculate_overfitting_score(self, temporal_consistency: float, feature_correlation: float,
