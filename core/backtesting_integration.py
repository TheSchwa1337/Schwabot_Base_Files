...
def _validate_strategy_mathematically(self, strategy_name: str, -> None
...
def _create_backtest_result_with_mathematical_analysis(self, strategy_name: str, asset_pair: str, -> None
