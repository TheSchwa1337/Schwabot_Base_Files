...
class EntropySignalIntegrator:
    ...
    def __init__(self, config_path: str = "config/entropy_signal_integration.yaml"):
    ...
    def _update_signal_buffers(self, signal: EntropySignal):
    ...
    def _adapt_timing_cycles(self, signal: EntropySignal):
    ...
    def _update_performance_metrics(self, signal: EntropySignal):
        """Update performance metrics."""
        try:
