...
class OrderBookManager:
    ...
    def _update_market_depth(self, symbol: str, snapshot: OrderBookSnapshot):
    ...
    def _trigger_callbacks(self, symbol: str, snapshot: OrderBookSnapshot):
    ...
    def register_callback(self, symbol: str, callback: Callable[[OrderBookSnapshot], None]):
    ...
    def unregister_callback(self, symbol: str, callback: Callable[[OrderBookSnapshot], None]):
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_historical_records": sum(
                len(data) for data in self.historical_data.values()
            ),
            "registered_callbacks": sum(
                len(callbacks) for callbacks in self.update_callbacks.values()
            ),
        }
