...
def concat_csv_to_parquet(asset: str, quote: str = "usdc"):
    """Concatenates CSV files for a given asset into a single Parquet file."""
...
def load_historical_data(asset: str, quote: str = "usdc") -> pd.DataFrame:
    """Loads historical data for a given asset, either from Parquet or by concatenating CSVs."""
