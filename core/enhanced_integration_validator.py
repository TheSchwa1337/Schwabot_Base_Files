    ...
    def run_complete_validation(self) -> Dict[str, Any]:
        ...
        for validation_func in validations:
            try:
                ...
                safe_print(f"  {status} {result.validation_name}: {result.passed_tests}/{result.total_tests} tests passed")
                ...
                for test_result in result.test_results:
                    ...
                    safe_print(f"    {test_status} {test_result.test_name}: {'PASS' if test_result.success else 'FAIL'}")
