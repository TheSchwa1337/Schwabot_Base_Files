...
class FlaskAIAgentHandler:
    ...
    def _setup_routes(self):
        ...
        def build_consensus():
            ...
            try:
                ...
                recent_responses = [
                    r for r in self.agent_responses[-50:]  # Last 50 responses
                    if r.hash_signature == hash_signature
                ]
        ...
        def get_system_performance():
            ...
            try:
                ...
                consensus_success_rate = (
                    sum(1 for c in recent_consensus if c.consensus_score > self.config.get("consensus_threshold", 0.6))
    ...
    def _update_agent_memory(self, agent_request: AgentRequest, agent_response: AgentResponse):
        """
    ...
    def _build_consensus(self, responses: List[AgentResponse], hash_signature: str) -> ConsensusResult:
        ...
        try:
            ...
            # Generate reasoning
            reasoning = f"Consensus: {final_action.value} with {consensus_score:.2f} agreement from {total_responses} agents"
