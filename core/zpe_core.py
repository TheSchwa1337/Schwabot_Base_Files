...
class ZPECalculator:
    ...
    def __init__(self, config: Optional[ZPEConfig] = None):
        self.config = config or ZPEConfig()
        self.logger = logging.getLogger(f"{__name__}.ZPECalculator")
        
    def calculate_zero_point_energy(self, signal_data: np.ndarray, 
    ...
    def calculate_thermal_efficiency(self, zpe_value: float, 
    ...
    def calculate_zpe_work(self, zpe_value: float, 
...
class ZPEHandoffManager:
    ...
    def handle_gpu_cpu_handoff(self, data: np.ndarray, 
...
class ZPEMode:
    ...
    def calculate_zero_point_energy(self, signal_data: Union[List, np.ndarray], 
