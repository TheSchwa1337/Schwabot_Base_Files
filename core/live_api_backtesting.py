...
Main Classes:
- BacktestMode: Core backtestmode functionality
- LiveAPIConfig: Core liveapiconfig functionality
- LiveMarketData: Core livemarketdata functionality
...
class BacktestMode:
    """
    BacktestMode Implementation
    Provides core live api backtesting functionality.
    """

    def __init__(self,   config: Optional[Dict[str, Any]] = None) -> None:
        """Initialize BacktestMode with configuration."""
...
def create_live_api_backtesting(config: Optional[Dict[str, Any]] = None):
    """Create a live api backtesting instance."""
    return BacktestMode(config)
