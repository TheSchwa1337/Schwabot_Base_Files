                                                                                ...
                                                                                last_value = values[-1]
                                                                                    ...
                                                                                    trend_percent = ((last_value - first_value) / first_value) * 100
                                                                                        ...
                                                                                        return parsed_data
                                                                                            ...
                                                                                            logger.error(f"{self.NAME}: failed to parse Glassnode data – {exc}")
                                                                                        return {
                                                                                        "asset": self.asset,
                                                                                        "metrics": {},
                                                                                        "latest_values": {},
                                                                                                                                                    ...
                                                                                                                                                    mvrv_score = 80   # Undervalued
                                                                                                                                                        ...
                                                                                                                                                        mvrv_score = 50   # Fair value
                                                                                                                                                            ...
                                                                                                                                                            mvrv_score = 20   # Overvalued
                                                                                                                                                                ...
                                                                                                                                                                # NVT scoring (0-100)
                                                                                                                                                                    if nvt < 20:
                                                                                                                                                                    nvt_score = 100   # Very low NVT (good)
                                                                                                                                                                        elif nvt < 50:
                                                                                                                                                                        nvt_score = 80    # Low NVT
                                                                                                                                                                            elif nvt < 100:
                                                                                                                                                                            nvt_score = 50    # Normal NVT
                                                                                                                                                                                else:
                                                                                                                                                                                nvt_score = 20    # High NVT (bad)
                                                                                                                                                                                    ...
                                                                                                                                                                                    sopr_score = 100  # Strong selling pressure
                                                                                                                                                                                        ...
                                                                                                                                                                                        sopr_score = 80   # Some selling pressure
                                                                                                                                                                                            ...
                                                                                                                                                                                            sopr_score = 50   # Neutral
                                                                                                                                                                                                ...
                                                                                                                                                                                                # Weighted average
                                                                                                                                                                                                valuation_score = (mvrv_score * 0.4 + nvt_score * 0.3 + sopr_score * 0.3)
