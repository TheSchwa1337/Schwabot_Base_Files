...
def process_waveform_complete(self, t: float, seq: List[float], -> None
...
def process_matrix_complete(self, hash_value: str, tick: int, price: float, -> None
...
def allocate(self, execution_packet: Dict[str, Any], -> None
...
def process_btc_trading_complete(self, price: float, volume: float, -> None
