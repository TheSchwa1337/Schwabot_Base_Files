...
class StrategyConsensusRouter:
    ...
    def initialize_trust_profiles(self):
    ...
    def _update_trust_profile(self, strategy_vote: StrategyVote):
    ...
    def _update_consensus_metrics(self, consensus_result: ConsensusResult):
    ...
    def _update_route_metrics(self, route_decision: RouteDecision):
