    ...
    def __init__(self, strategies_config: Dict[str, List[float]]):
        ...
        Args:
            strategies_config: A dictionary where keys are strategy IDs and values
                               are lists of floats representing their vector signatures.
        """
...
if __name__ == "__main__":
    ...
    print(f"Test Vector 1: {test_vector_1}")
    ...
    print(f"Test Vector 2: {test_vector_2}")
