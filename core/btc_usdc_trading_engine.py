...
class BTCTradingEngine:
    ...
    def create_strategy_matrix(self, matrix_id: str, bit_level: BitLevel, 
    ...
    def _calculate_signal_confidence(self, price_data: BTCPriceData, 
    ...
    def _calculate_position_size(self, price_data: BTCPriceData, 
                               thermal_mode: TradingMode, bit_level: BitLevel) -> float:
