...
class RegistryStrategy:
    ...
    def __init__(self, hash_id: str, registry_path: str = "registry/hashed_strategies.json"):
...
# Factory function
def create_registry_strategy(hash_id: str, registry_path: str = "registry/hashed_strategies.json") -> RegistryStrategy:
