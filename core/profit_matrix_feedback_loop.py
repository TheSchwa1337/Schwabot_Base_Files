...
class ProfitMatrixFeedbackLoop:
    ...
    def _determine_feedback_mode(self, backtest_result: BacktestResult, 
    ...
    def _update_matrix(self, matrix_name: str, matrix: np.ndarray,
    ...
    def _calculate_profit_delta(self, matrix: np.ndarray, backtest_result: BacktestResult,
    ...
    def _calculate_risk_delta(self, matrix: np.ndarray, backtest_result: BacktestResult,
                            feedback_mode: FeedbackMode) -> np.ndarray:
    ...
    def _calculate_timing_delta(self, matrix: np.ndarray, backtest_result: BacktestResult,
                              feedback_mode: FeedbackMode) -> np.ndarray:
    ...
    def _calculate_volume_delta(self, matrix: np.ndarray, backtest_result: BacktestResult,
                              feedback_mode: FeedbackMode) -> np.ndarray:
    ...
    def _calculate_entropy_delta(self, matrix: np.ndarray, backtest_result: BacktestResult,
                               feedback_mode: FeedbackMode) -> np.ndarray:
