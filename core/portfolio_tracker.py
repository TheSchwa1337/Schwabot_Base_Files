...
class Position:
    ...
    def update_unrealized(self, price: Decimal):
...
class PortfolioTracker:
    def __init__(self, base_currency: str = 'USDC', initial_balances: Optional[Dict[str, Union[float, Decimal]]] = None):
    ...
    def sync_balances(self, ccxt_balance: Dict[str, Any]):
    ...
    def open_position(self, symbol: str, quantity: Union[float, Decimal], price: Union[float, Decimal], side: str, stop_loss: Optional[float] = None, take_profit: Optional[float] = None, metadata: Optional[Dict[str, Any]] = None):
    ...
    def close_position(self, pos_id: str, price: Union[float, Decimal]):
    ...
    def update_prices(self, price_map: Dict[str, Union[float, Decimal]]):
