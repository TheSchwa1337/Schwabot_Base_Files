...
class ImportResolver:
    ...
    def _register_default_fallbacks(self) -> None:
        ...
        self._fallback_registry.update({
            ...
            'ncco_core':
                self._create_ncco_core_fallback,
            'schwabot':
                self._create_schwabot_fallback,
            'ccxt':
                self._create_ccxt_fallback,
            'websockets':
                self._create_websockets_fallback,
            'talib':
                self._create_talib_fallback,
            'psutil':
                self._create_psutil_fallback,
        })

    def safe_import(self, module_name: str, class_names: List[str],
    ...
    def _create_corridor_engine_fallback(self, class_name: str) -> Mock:
        ...
        if class_name in ['FutureCorridorEngine', 'CorridorState',
                         'ExecutionPath', 'ProfitTier']:
