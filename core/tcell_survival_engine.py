...
def create_tcell_strategy(self, source_asset: str, target_asset: str, -> None
...
def activate_tcell(self, strategy_hash: str, omega_a: float, xi_a: float, -> None
...
def update_tcell_survival(self, strategy_hash: str, roi: float, success: bool) -> None:
                                        """
...
def get_front_run_candidates(self, source_asset: str, omega_a: float, -> None
...
def cleanup_exhausted_tcells(self) -> None:
...
def _load_tcell_population(self) -> None:
...
def _create_default_tcells(self) -> None:
