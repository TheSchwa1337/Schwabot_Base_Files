    ...
    def _initialize_component_statuses(self):
        ...
        for name, info in all_components.items():
            self.components[name] = ComponentStatus(
                name=name, type=info["type"], config=info
            )
    ...
    def get_system_overview(self) -> Dict[str, Any]:
        ...
        overview = {
            ...
            "healthy_components": sum(
                1 for c in self.components.values() if c.health == "healthy"
            ),
            "components_by_type": {},
