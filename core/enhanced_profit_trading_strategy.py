...
class EnhancedProfitTradingStrategy:
    ...
    def _calculate_optimal_quantity(self, market_data: Dict[str, Any], profit_potential: float, risk_score: float) -> float:
    ...
    def get_strategy_stats(self) -> Dict[str, Any]:
        ...
        avg_profit_potential = sum(s.profit_potential for s in self.signal_history) / total_signals if total_signals > 0 else 0.0
