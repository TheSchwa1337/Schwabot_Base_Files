...
class BTCInvestmentRatioController:
    ...
    def analyze_investment_ratio(
        ...
        try:
            ...
            core_signals, btc_signals = collect_unified_signals(
                cursor_state, fractal_state, collapse_state,
                market_data, btc_data, volume_data, network_data
            )
    ...
    def _determine_investment_decision(
        ...
        elif execution_confidence < self.confidence_threshold_low or entry_score < self.entry_score_threshold_low:
            if btc_strength < 0.3:
    ...
    def _calculate_btc_allocation_ratio(
        ...
        # Apply bounds
        allocation = max(self.min_btc_allocation, min(self.max_btc_allocation, base_allocation))
    ...
    def get_performance_summary(self) -> Dict:
        ...
        return {
            ...
            "latest_decision": recent_decisions[-1].decision.value if recent_decisions else None,
        }
