...
class DynamicSwitchCalculator:
    ...
    def __init__(self, config: Optional[FlipSwitchConfig] = None):
    ...
    def compute_dynamic_switch_matrix(self, condition_matrix: np.ndarray,
    ...
    def update_adaptive_thresholds(self, current_thresholds: np.ndarray,
    ...
    def compute_strategy_activation_vector(self, switch_matrix: np.ndarray,
