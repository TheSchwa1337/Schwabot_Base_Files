...
def analyze_market_mathematics(self, price_data: np.ndarray, volume_data: np.ndarray, -> None
...
def _compute_collapse_function(self, price_tensor: np.ndarray, -> None
...
def _make_math_decision(self, tensor_state: TensorState, eigenvalues: np.ndarray, -> None
...
def _calculate_math_confidence(self, eigenvalues: np.ndarray, tensor_norm: float, -> None
...
def _calculate_math_risk(self, tensor_state: TensorState, eigenvalues: np.ndarray, -> None
