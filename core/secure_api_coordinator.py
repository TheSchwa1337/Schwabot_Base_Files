...
logger.info(
f"✅ Loaded credentials for {
provider.value}""
)

except Exception as e:
                        logger.error(
f"Failed to load credentials for {provider_name}: {e}"
)
...
return True
            ...
            logger.error(
f"Failed to store credentials for {
provider.value}: {e}""
)
return False
...
return False
            ...
            logger.error(
f"Failed to remove credentials for {
provider.value}: {e}""
)
return False
...
if provider not in test_endpoints:
                logger.warning(
f"No test endpoint defined for {
provider.value}""
)
...
return False
            ...
            logger.error(
f"Error testing credentials for {
provider.value}: {e}""
)
return False
