...
class PhantomRegistry:
    ...
    def _generate_mathematical_signature(self, pattern_data: Dict[str, Any], 
    ...
    def _create_registered_pattern(self, pattern_data: Dict[str, Any],
    ...
    def get_registered_patterns(self, category: Optional[PatternCategory] = None,
