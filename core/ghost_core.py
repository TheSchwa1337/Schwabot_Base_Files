...
class GhostCore:
    ...
    def switch_strategy(
        ...
        new_branch = self.determine_strategy_branch(hash_signature, market_conditions, mathematical_state)
        ...
        profit_potential = self._calculate_profit_potential(new_branch, market_conditions, mathematical_state)
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            'current_branch': self.current_state.current_branch.value if self.current_state else None,
            'memory_depth': len(self.hash_history),
...
def demo_ghost_core():
    ...
    for i in range(10):
        ...
        print(f"  Confidence: {state.confidence:.3f}, Profit Potential: {state.profit_potential:.4f}")
