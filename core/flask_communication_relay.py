...
from core.internal_ai_agent_system import (
    get_communication_hub, create_agent_system, MarketData, TradingSuggestion
)
...
class FlaskCommunicationRelay:
    ...
    def _setup_routes(self):
        ...
        def get_agent_suggestions():
            ...
            try:
                ...
                # Build consensus
                consensus = asyncio.run(self.communication_hub.build_consensus(suggestions))
        ...
        def calculate_zbe():
            ...
            try:
                ...
                import numpy as np
                probability_distribution = np.array(data.get('probabilities', [0.25, 0.25, 0.25, 0.25]))
    ...
    def _setup_socketio_events(self):
        ...
        def handle_disconnect():
            ...
            self.performance_metrics['websocket_connections'] = max(0, self.performance_metrics['websocket_connections'] - 1)
    ...
    async def _get_all_agent_suggestions(self, market_data: MarketData) -> List[TradingSuggestion]:
        """Get suggestions from all agents."""
        suggestions = []
        ...
        for agent in self.agents.values():
            try:
                ...
                logger.error("Failed to get suggestion from agent {}: {}".format(agent.agent_id, e))
