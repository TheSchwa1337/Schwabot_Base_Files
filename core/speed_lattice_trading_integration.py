...
class SpeedLatticeTradingIntegrator:
    ...
    def update_node_state(self, node_name: str, state: LatticeState, speed: float = None, 
    ...
    def _execute_strategy(self, strategy: TradingStrategy, tick_data: Dict[str, Any], 
