...
class StrategyMapper:
    ...
    def __init__(
        ...
        *,
        ...
        safe_safe_print(
            f"Hybrid Strategy Mapper initialized with: {', '.join(paths_enabled)}")
    ...
    def map_strategy(
        ...
        try:
            ...
            if should_use_legacy and self.enable_legacy:
                ...
                return self._fallback_strategy(execution_packet, "No valid path available")
    ...
    async def _legacy_enhanced_core(
        ...
        try:
            ...
            if self.memory_allocator:
                memory_key = self.memory_allocator.allocate_key(KeyType.STRATEGY)
            ...
            if self.zpe_core:
                zpe_result = self.zpe_core.analyze_execution_packet(execution_packet)
