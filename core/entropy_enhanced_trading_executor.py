...
class EntropyEnhancedTradingExecutor:
    ...
    async def _generate_trading_decision(self, market_data: Dict[str, Any]) -> TradingDecision:
    ...
    async def _execute_trade(self, decision: TradingDecision) -> TradingResult:
        ...
        try:
            ...
            self.current_position += executed_quantity if decision.action == TradingAction.BUY else -executed_quantity
            return TradingResult(
                success=True,
