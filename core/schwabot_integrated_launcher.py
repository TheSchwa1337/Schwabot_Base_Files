...
status_frame, height=10, bg="#2a2a2a", fg="#"
)"
...
stats_frame, height=10, bg="#2a2a2a", fg="#"
)"
...
10, 50, 10 + short_width, 80, fill="#ff6b6b", outline="#"
)
self.memory_canvas.create_text("
canvas_width / 6, 35, text="Short-term", fill="#"
)
self.memory_canvas.create_text(
canvas_width / 6,
95,"
...
self.memory_canvas.create_rectangle("
mid_x, 50, mid_x + mid_width, 80, fill="#ffd93d", outline="#"
)
self.memory_canvas.create_text("
mid_x + (canvas_width / 6), 35, text="Mid-term", fill="#"
)
self.memory_canvas.create_text(
...
self.memory_canvas.create_rectangle("
long_x, 50, long_x + long_width, 80, fill="#6bcf7", outline="#"
)
self.memory_canvas.create_text("
long_x + (canvas_width / 6), 35, text="Long-term", fill="#"
)
self.memory_canvas.create_text(
...
"
weather_text = tk.Text(weather_window, bg="#2a2a2a", fg="#")"
...
"
data_text = tk.Text(data_window, bg="#2a2a2a", fg="#")"
