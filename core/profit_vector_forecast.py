...
3. Phase vector analysis ((t)) for peak/valley/wave-shift detection
...
def detect_market_phase():-> MarketPhase:
        ...
        Detect current market phase for (t) calculation.Args:
...
# 4. Calculate timeframe confluence _confluence
...
# 5. Calculate volatility scaling _scale
