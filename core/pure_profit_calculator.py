...
class PureProfitCalculator:
    ...
    def _calculate_base_profit_safe(
        self, market_data: MarketData, history_state: HistoryState, processing_mode: ProcessingMode
    ) -> float:
    ...
    def _calculate_tensor_contribution(self, market_data: MarketData, history_state: HistoryState) -> float:
    ...
    def _calculate_hash_contribution(self, market_data: MarketData, history_state: HistoryState) -> float:
    ...
    def calculate_market_entropy(self, price_changes: np.ndarray) -> float:
        ...
        try:
            ...
            entropy_value = scipy_entropy(probabilities + 1e-10)  # Add small epsilon to avoid log(0)
