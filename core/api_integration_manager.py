                                                                            ...
                                                                            self.logger.info("🔄 Starting API integration cycle")
                                                                                ...
                                                                                # Step 3: Update thermal systems
                                                                                    ...
                                                                                    # Step 4: Update profit scheduler
                                                                                        ...
                                                                                        self.logger.info(f"✅ Integration cycle completed in {cycle_time:.2f}s")
                                                                                                ...
                                                                                                """Fetch data from external APIs."""
                                                                                                    ...
                                                                                                    # Fetch Glassnode data
                                                                                                        if self.glassnode_handler:
                                                                                                            ...
                                                                                                            self.logger.debug("✅ Glassnode data fetched successfully")
                                                                                                                except Exception as e:
                                                                                                                self.logger.error(f"❌ Error fetching Glassnode data: {e}")
                                                                                                                ...
                                                                                                                # Fetch Whale Alert data
                                                                                                                    if self.whale_alert_handler:
                                                                                                                        ...
                                                                                                                        self.logger.debug("✅ Whale Alert data fetched successfully")
                                                                                                                            except Exception as e:
                                                                                                                            self.logger.error(f"❌ Error fetching Whale Alert data: {e}")
                                                                                                                                    ...
                                                                                                                                    """Process and integrate API data."""
                                                                                                                                        ...
                                                                                                                                        # Process Glassnode data for thermal integration
                                                                                                                                            ...
                                                                                                                                            thermal_data = self.glassnode_handler.get_thermal_integration_data()
                                                                                                                                                ...
                                                                                                                                                self.logger.debug("✅ Glassnode thermal data processed")

                                                                                                                                                # Process Whale Alert data for thermal integration
                                                                                                                                                    if self.whale_alert_data and self.whale_alert_handler:
                                                                                                                                                    thermal_data = self.whale_alert_handler.get_thermal_integration_data()
                                                                                                                                                        if thermal_data.get("thermal_ready", False):
                                                                                                                                                        self.logger.debug("✅ Whale Alert thermal data processed")

                                                                                                                                                            except Exception as e:
                                                                                                                                                            self.logger.error(f"❌ Error processing integration data: {e}")
                                                                                                                                                                ...
                                                                                                                                                                """Update ZPE/ZBE thermal systems with API data."""
                                                                                                                                                                    ...
                                                                                                                                                                    # Update thermal strategy router with API data
                                                                                                                                                                        if self.thermal_router:
                                                                                                                                                                        thermal_signals = self._generate_thermal_signals()
                                                                                                                                                                            if thermal_signals:
                                                                                                                                                                            # Update thermal router with API-enhanced signals
                                                                                                                                                                            self.logger.debug("✅ Thermal systems updated with API data")

                                                                                                                                                                            # Update heartbeat integration manager
                                                                                                                                                                                if self.heartbeat_manager:
                                                                                                                                                                                heartbeat_data = self._generate_heartbeat_data()
                                                                                                                                                                                    if heartbeat_data:
                                                                                                                                                                                    # Update heartbeat manager with API data
                                                                                                                                                                                    self.logger.debug("✅ Heartbeat manager updated with API data")

                                                                                                                                                                                        except Exception as e:
                                                                                                                                                                                        self.logger.error(f"❌ Error updating thermal systems: {e}")
                                                                                                                                                                                            ...
                                                                                                                                                                                            """Update profit scheduler with API data."""
                                                                                                                                                                                                ...
                                                                                                                                                                                                # Update profit echo cache with whale activity
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    whale_scheduler_data = self.whale_alert_handler.get_profit_scheduler_data()
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        self.logger.debug("✅ Profit echo cache updated with whale data")

                                                                                                                                                                                                        # Update drift band profiler with on-chain metrics
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            glassnode_scheduler_data = self.glassnode_handler.get_profit_scheduler_data()
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                self.logger.debug("✅ Drift profiler updated with on-chain data")

                                                                                                                                                                                                                    except Exception as e:
                                                                                                                                                                                                                    self.logger.error(f"❌ Error updating profit scheduler: {e}")
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    self.logger.info("✅ Integrated signals generated successfully")
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        self.logger.error(f"❌ Error generating integrated signals: {e}")
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            """Generate trading signals from Glassnode data."""
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                latest_values = self.glassnode_data.get("latest_values", {})
                                                                                                                                                                                                                                                composite_scores = self.glassnode_data.get("composite_scores", {})
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                signals["overall_signal"] = self._calculate_overall_glassnode_signal(signals)

                                                                                                                                                                                                                                            return signals

                                                                                                                                                                                                                                                except Exception as e:
                                                                                                                                                                                                                                                self.logger.error(f"Error generating Glassnode signals: {e}")
                                                                                                                                                                                                                                            return {}
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                """Generate trading signals from Whale Alert data."""
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    whale_scores = self.whale_alert_data.get("whale_activity_scores", {})
                                                                                                                                                                                                                                                    market_impact = self.whale_alert_data.get("market_impact_analysis", {})
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    # Calculate overall signal
                                                                                                                                                                                                                                                    signals["overall_signal"] = self._calculate_overall_whale_signal(signals)

                                                                                                                                                                                                                                                return signals

                                                                                                                                                                                                                                                    except Exception as e:
                                                                                                                                                                                                                                                    self.logger.error(f"Error generating Whale Alert signals: {e}")
                                                                                                                                                                                                                                                return {}

                                                                                                                                                                                                                                                    def _generate_combined_signals(self) -> Dict[str, Any]:
                                                                                                                                                                                                                                                    """Generate combined signals from both APIs."""
                                                                                                                                                                                                                                                        try:
                                                                                                                                                                                                                                                        glassnode_signals = self.integrated_signals.get("glassnode_signals", {})
                                                                                                                                                                                                                                                        whale_signals = self.integrated_signals.get("whale_alert_signals", {})
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        glassnode_confidence = self._signal_to_confidence(glassnode_signals.get("overall_signal", "neutral"))
                                                                                                                                                                                                                                                        whale_confidence = self._signal_to_confidence(whale_signals.get("overall_signal", "neutral"))

                                                                                                                                                                                                                                                        combined["confidence_score"] = (glassnode_confidence + whale_confidence) / 2

                                                                                                                                                                                                                                                        # Determine action signal
                                                                                                                                                                                                                                                        combined["action_signal"] = self._determine_action_signal(glassnode_signals, whale_signals)

                                                                                                                                                                                                                                                        # Determine risk level
                                                                                                                                                                                                                                                        combined["risk_level"] = self._determine_risk_level(glassnode_signals, whale_signals)

                                                                                                                                                                                                                                                        # Calculate adjustments
                                                                                                                                                                                                                                                        combined["volume_adjustment"] = self._calculate_volume_adjustment(combined)
                                                                                                                                                                                                                                                        combined["timing_adjustment"] = self._calculate_timing_adjustment(combined)
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    return {}
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        return "strong_sell"  # Heavily overvalued
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            """Interpret NVT (Network Value to Transactions) ratio."""
                                                                                                                                                                                                                                                                if nvt < 20:
                                                                                                                                                                                                                                                            return "strong_buy"  # Very low NVT (good)
                                                                                                                                                                                                                                                                elif nvt < 50:
                                                                                                                                                                                                                                                            return "buy"  # Low NVT
                                                                                                                                                                                                                                                                elif nvt < 100:
                                                                                                                                                                                                                                                            return "neutral"  # Normal NVT
                                                                                                                                                                                                                                                                else:
                                                                                                                                                                                                                                                            return "sell"  # High NVT (bad)

                                                                                                                                                                                                                                                                def _interpret_sopr(self, sopr: float) -> str:
                                                                                                                                                                                                                                                                """Interpret SOPR (Spent Output Profit Ratio)."""
                                                                                                                                                                                                                                                                    if sopr < 0.98:
                                                                                                                                                                                                                                                                return "strong_buy"  # Strong selling pressure (good for buying)
                                                                                                                                                                                                                                                                    elif sopr < 1.0:
                                                                                                                                                                                                                                                                return "buy"  # Some selling pressure
                                                                                                                                                                                                                                                                    elif sopr < 1.02:
                                                                                                                                                                                                                                                                return "neutral"  # Neutral
                                                                                                                                                                                                                                                                    else:
                                                                                                                                                                                                                                                                return "sell"  # Strong buying pressure (good for selling)
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    """Calculate overall Glassnode signal."""
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        mvrv_score = self._signal_to_score(signals.get("mvrv_signal", "neutral"))
                                                                                                                                                                                                                                                                        nvt_score = self._signal_to_score(signals.get("nvt_signal", "neutral"))
                                                                                                                                                                                                                                                                        sopr_score = self._signal_to_score(signals.get("sopr_signal", "neutral"))
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    return self._score_to_signal(weighted_score)

                                                                                                                                                                                                                                                                        except Exception as e:
                                                                                                                                                                                                                                                                        self.logger.error(f"Error calculating overall Glassnode signal: {e}")
                                                                                                                                                                                                                                                                    return "neutral"

                                                                                                                                                                                                                                                                        def _calculate_overall_whale_signal(self, signals: Dict[str, Any]) -> str:
                                                                                                                                                                                                                                                                        """Calculate overall Whale Alert signal."""
                                                                                                                                                                                                                                                                            try:
                                                                                                                                                                                                                                                                            buying_pressure = signals.get("buying_pressure", 0.0)
                                                                                                                                                                                                                                                                            selling_pressure = signals.get("selling_pressure", 0.0)
                                                                                                                                                                                                                                                                            market_impact = signals.get("market_impact", 0.0)
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            return "neutral"
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                self.logger.error(f"Error calculating overall whale signal: {e}")
                                                                                                                                                                                                                                                                            return "neutral"
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            return signal_map.get(signal, 0.0)
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                return confidence_map.get(signal, 0.5)
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    """Determine overall action signal from both APIs."""
                                                                                                                                                                                                                                                                                        try:
                                                                                                                                                                                                                                                                                        glassnode_signal = glassnode_signals.get("overall_signal", "neutral")
                                                                                                                                                                                                                                                                                        whale_signal = whale_signals.get("overall_signal", "neutral")

                                                                                                                                                                                                                                                                                        # Combine signals with weights
                                                                                                                                                                                                                                                                                        glassnode_weight = 0.6  # On-chain metrics more reliable
                                                                                                                                                                                                                                                                                        whale_weight = 0.4      # Whale activity more volatile

                                                                                                                                                                                                                                                                                        glassnode_score = self._signal_to_score(glassnode_signal)
                                                                                                                                                                                                                                                                                        whale_score = self._signal_to_score(whale_signal)
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    return self._score_to_signal(combined_score)
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        self.logger.error(f"Error determining action signal: {e}")
                                                                                                                                                                                                                                                                                    return "neutral"

                                                                                                                                                                                                                                                                                        def _determine_risk_level(self, glassnode_signals: Dict, whale_signals: Dict) -> str:
                                                                                                                                                                                                                                                                                        """Determine overall risk level from both APIs."""
                                                                                                                                                                                                                                                                                            try:
                                                                                                                                                                                                                                                                                            whale_impact = whale_signals.get("market_impact", 0.0)
                                                                                                                                                                                                                                                                                            whale_risk = whale_signals.get("whale_signal", "low")

                                                                                                                                                                                                                                                                                            # High whale activity increases risk
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            return "medium"
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                """Calculate volume adjustment factor."""
                                                                                                                                                                                                                                                                                                    try:
                                                                                                                                                                                                                                                                                                    confidence = combined_signals.get("confidence_score", 0.5)
                                                                                                                                                                                                                                                                                                    risk_level = combined_signals.get("risk_level", "medium")

                                                                                                                                                                                                                                                                                                    # Base adjustment on confidence
                                                                                                                                                                                                                                                                                                    base_adjustment = 0.5 + (confidence * 0.5)  # 0.5 to 1.0
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                return base_adjustment * risk_multiplier
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    self.logger.error(f"Error calculating volume adjustment: {e}")
                                                                                                                                                                                                                                                                                                return 1.0
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    """Calculate timing adjustment factor."""
                                                                                                                                                                                                                                                                                                        try:
                                                                                                                                                                                                                                                                                                        confidence = combined_signals.get("confidence_score", 0.5)
                                                                                                                                                                                                                                                                                                        action_signal = combined_signals.get("action_signal", "neutral")

                                                                                                                                                                                                                                                                                                        # Higher confidence = faster execution
                                                                                                                                                                                                                                                                                                        base_timing = 1.0 - (confidence * 0.3)  # 0.7 to 1.0

                                                                                                                                                                                                                                                                                                        # Strong signals = faster execution
                                                                                                                                                                                                                                                                                                            if "strong" in action_signal:
                                                                                                                                                                                                                                                                                                            base_timing *= 0.8

                                                                                                                                                                                                                                                                                                        return max(0.5, base_timing)  # Minimum 0.5x timing

                                                                                                                                                                                                                                                                                                            except Exception as e:
                                                                                                                                                                                                                                                                                                            self.logger.error(f"Error calculating timing adjustment: {e}")
                                                                                                                                                                                                                                                                                                        return 1.0
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            "whale_thermal": self.whale_alert_handler.get_thermal_integration_data() if self.whale_alert_handler else {},
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                self.logger.error(f"Error generating thermal signals: {e}")
                                                                                                                                                                                                                                                                                                            return {}
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                return {}
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    "thermal_pressure": 0.5,
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        self.logger.error(f"Error generating thermal adjustments: {e}")
                                                                                                                                                                                                                                                                                                                    return {}

                                                                                                                                                                                                                                                                                                                        def _generate_profit_adjustments(self) -> Dict[str, Any]:
                                                                                                                                                                                                                                                                                                                        """Generate profit adjustments for scheduler."""
                                                                                                                                                                                                                                                                                                                            try:
                                                                                                                                                                                                                                                                                                                            combined_signals = self.integrated_signals.get("combined_signals", {})
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        "confidence_boost": combined_signals.get("confidence_score", 0.5),
                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                            self.logger.error(f"Error generating profit adjustments: {e}")
                                                                                                                                                                                                                                                                                                                        return {}
