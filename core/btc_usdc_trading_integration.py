...
class BTCUSDCTradingIntegration:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            error(f"Error initializing BTC/USDC trading integration: {e}")
            return False
    ...
    async def execute_trade(self, decision: TradingDecision) -> bool:
        ...
        try:
            ...
            if success:
                ...
                success(f"Trade executed: {decision.symbol} {decision.action.value} {decision.quantity}")
                return True
            else:
                warn(f"Trade execution failed: {decision.symbol}")
                return False
