...
class MasterCycleEngine:
    ...
    def _log_decision(self, diagnostics: SystemDiagnostics) -> None:
        ...
        logger.log(
            log_level,
            f"🎯 Trading Decision: {
                diagnostics.trading_decision.value.upper()} "
            f"(confidence: {
                diagnostics.confidence_score:.3f}, "
            f"risk: {
    ...
    def get_fibonacci_echo_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "quantum_scores": [
                d.tensor_analysis["quantum_score"] for d in recent_decisions
            ],
            "phi_resonances": [
                d.tensor_analysis["phi_resonance"] for d in recent_decisions
            ],
