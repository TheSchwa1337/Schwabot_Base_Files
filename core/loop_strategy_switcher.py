...
class StrategyLoopSwitcher:
            ...
            for asset_target in asset_targets:
                try:
                    ...
                    if within_warp:
                        ...
                        logger.info("🕒 {0} not ready. Warp window opens in {1}s".format(asset_target.symbol, wait_time))
    ...
    def _fetch_top_assets_data(self) -> List[Dict[str, Any]]:
        ...
        mock_data = []
            ...
            {"symbol": "SOL", "price": 100, "volume": 3000000000, "price_change": 8.2, "market_cap": 40000000000},
            {"symbol": "ADA", "price": 0.4, "volume": 1500000000, "price_change": -2.1, "market_cap": 14000000000},
            {"symbol": "AVAX", "price": 25, "volume": 800000000, "price_change": 12.5, "market_cap": 8000000000},
