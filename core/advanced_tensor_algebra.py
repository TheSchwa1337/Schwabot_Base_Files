...
class AdvancedTensorAlgebra:
    ...
    def contract_tensors(
        tensor_a: np.ndarray, tensor_b: np.ndarray, axes: List[List[int]]
    ) -> np.ndarray:
        """
    ...
    @staticmethod
    def a(t: float, xi: np.ndarray) -> np.ndarray:
        """
    ...
    @staticmethod
    def omega(t: float, xi: np.ndarray) -> np.ndarray:
        """
