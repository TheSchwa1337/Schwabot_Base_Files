...
class LiveTradingSystem:
    ...
    def _process_price_update(self, price_update: PriceUpdate):
    ...
    def _check_math_signals(self, price_update: PriceUpdate):
    ...
    def _check_risk_management(self, price_update: PriceUpdate):
    ...
    def _record_trade(self, symbol: str, side: str, amount: float, price: float, 
    ...
    def _execute_math_signal(self, math_signal: MathSignal):
    ...
    def _notify_trade_callbacks(self, event_type: str, data: Any, metadata: Dict[str, Any] = None):
    ...
    def _notify_alert_callbacks(self, alert_type: str, data: Dict[str, Any]):
    ...
    def _notify_performance_callbacks(self, metrics: Dict[str, Any]):
