        ...
        self.strategy_configs = (
            ...
            if default_strategy_configs is not None
                ...
                "AggressiveScalp": {
                    ...
                    "base_leverage": 10,
                    "exit_target": 0.005,  # 0.5% profit target
                ...
                "DynamicSwing": {
                    ...
                    "risk_per_trade_percent": 0.015,  # 1.5% max risk per trade
                },
                "ConservativeFlip": {
                    "description": "Low-risk, patient entry/exit strategy.",
                    "base_leverage": 1,
                    "max_exposure_percent": 0.05,  # 5% of portfolio max
