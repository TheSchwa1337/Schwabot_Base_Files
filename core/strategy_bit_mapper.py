...
def _flip_expansion() -> List[int]:Flip-switch expansion with randomization.strategies = []
...
def _mirror_expansion() -> List[int]:Mirror function expansion.strategies = []
...
def _random_expansion() -> List[int]:Random expansion from strategy pool.strategies = [base_bits]  # Always include base strategy
