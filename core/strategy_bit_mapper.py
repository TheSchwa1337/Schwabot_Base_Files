...
def __init__(self, matrix_dir: str = "./matrices", config: Optional[Dict[str, Any]] = None) -> None:
...
def classify_signal(self, signal: np.ndarray, asset: str = "BTC", -> None
...
def expand_strategy_bits(self, strategy_id: int, target_bits: int = 8, -> None
