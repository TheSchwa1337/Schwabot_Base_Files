...
def test_fractal_memory_tracker():
    ...
    try:
        ...
        snapshot_id_1 = fractal_tracker.save_snapshot(q_matrix_1, strategy_id, profit_result=0.05)
        snapshot_id_2 = fractal_tracker.save_snapshot(q_matrix_2, strategy_id, profit_result=-0.02)
