...
class SchwabotruntimeValidator:
    ...
    def _check_flake8_compliance(self, result: ValidationResult) -> None:
        ...
        try:
            ...
            if process.returncode == 0:
                print("  ✅ All files pass Flake8 compliance")
            else:
                # Parse flake8 output
                for line in process.stdout.strip().split('\n'):
                    if line.strip():
                        ...
                        if len(parts) >= 4:
                            ...
                            print(f"  ❌ {file_path}: {error_details}")
            ...
            try:
                ...
                if total_functions > 0:
                    ...
                    if annotation_coverage < 0.8:  # Require 80% coverage
                        ...
                        print(f"  ✅ {file_path}: {annotation_coverage:.1%} type coverage")
    ...
    def _print_validation_summary(self, result: ValidationResult) -> None:
        ...
        print(f"Files Checked: {result.critical_files_checked}")
        ...
        print("\n" + "=" * 50)
        if result.passed:
            print("✅ VALIDATION PASSED - SYSTEM READY FOR EXECUTION")
        else:
            print("❌ VALIDATION FAILED - FIX ERRORS BEFORE RUNTIME")
            print("\n🛠️  RECOMMENDED ACTIONS:")
            print("1. Fix syntax errors first")
            print("2. Run: black core/ && flake8 core/")
            print("3. Check import paths and dependencies")
            print("4. Add missing mathematical functions")
            print("5. Improve type annotation coverage")
        print("=" * 50)
    ...
    def check_flake8_runtime_halt(self) -> bool:
        ...
        try:
            ...
            if result.returncode != 0:
                print("⚠️  Flake8 errors detected. Fix before runtime.")
                print(result.stdout)
                return True
            ...
            print(f"⚠️  Could not run Flake8 check: {e}")
            return False
    ...
    def create_validation_report(self, result: ValidationResult) -> str:
        ...
        report = f"""
# Schwabot Runtime Validation Report
Generated: {timestamp}
...
def main() -> None:
    ...
    if validator.check_flake8_runtime_halt():
        print("🛑 Runtime halted due to Flake8 violations")
        sys.exit(1)
