...
class EchoHashEngine:
    ...
    def __init__(
        self,
        recursive_registry: Any,  # Using Any to avoid circular import for now
    ...
    def detect_echo_and_gravitate(
        ...
        if sha_memory:
            ...
            echo_match_confidence = min(
                1.0, sha_memory["occurrences"] / 10.0
            ...
            recall_bias = (
                sha_memory["profit"] * echo_match_confidence
            )  # Higher profit + confidence -> positive bias
            ...
            if orbit_ring:
                ...
                echo_match_confidence = max(
                    echo_match_confidence, min(1.0, predicted_profit / 100.0)
                )
