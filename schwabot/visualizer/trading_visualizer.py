...
class TradingVisualizer:
    ...
    def get_portfolio_summary(self) -> Dict[str, Any]:
        ...
        active_positions = len([pos for pos in self.portfolio_positions.values() if pos['amount'] > 0])
    ...
    def get_trading_alerts(self) -> List[Dict[str, Any]]:
        ...
        recent_trades = [t for t in self.trade_history if current_time - t['timestamp'] <= 300]  # Last 5 minutes
        if recent_trades:
