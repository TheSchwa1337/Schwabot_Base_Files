...
MOCK_PRICE_DATA = {
    "BTC/USDC": {"price": 50000.0, "volume": 1000000.0, "timestamp": time.time()},
    "ETH/USDC": {"price": 3000.0, "volume": 500000.0, "timestamp": time.time()},
    "SOL/USDC": {"price": 100.0, "volume": 200000.0, "timestamp": time.time()},
}
    ...
    async def execute_entry(
        ...
        try:
            ...
            if not self._validate_trade(symbol, side, amount, price):
                ...
                return {"success": False, "error": error_msg, "trade_id": trade_id}
            # Execute trade
            if side.upper() == "BUY":
