    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        if self.enable_visualization:
            status["visualization"] = {
                ...
                "trading": (
                    self.trading_visualizer.get_all_trading_data()
...
async def create_schwabot_hub(
    initial_capital: float = 100000.0, debug: bool = False, enable_visualization: bool = True
):
    """
