...
def fix_profit_vector_forecast():
    ...
    try:
        ...
        for line in lines:
            ...
            if any(skip in line for skip in [
                ...
                if "dataclass" in line:
                    ...
                    fixed_lines.append("from core.drift_shell_engine import ProfitVector")
                else:
        ...
        content = '\n'.join(fixed_lines)
        content = content.replace('f"📈 Profit Vector Forecast Engine initialized with {lookback_periods} period lookback"', 
                                f'f"📈 Profit Vector Forecast Engine initialized with {{lookback_periods}} period lookback"')
