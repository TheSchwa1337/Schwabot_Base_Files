...
def run_performance_test():
    ...
    print("Running Memory Key Synchronizer Performance Test...")
    ...
    print(f"  Registration: {registration_time:.4f}s for 1000 keys")
    print(f"  Synchronization: {sync_time:.4f}s for {sync_count} operations")
    print(f"  Validation: {validation_time:.4f}s for 1000 keys")
    print(f"  Rotation: {rotation_time:.4f}s for {len(rotated_keys)} keys")
...
def main() -> None:
    ...
    print("Memory Key Synchronization System Tests")
    print("=" * 50)
