...
class RheologicalDemo:
    ...
    def demonstrate_function_differentiation(self):
        ...
        market_conditions = [
            {"name": "Calm Market", "volatility": 0.2, "volume_delta": 0.1, "price_momentum": 0.05},
        ...
        for condition in market_conditions:
            ...
            strategy_performance = {
                ...
                'profit_history': [np.random.uniform(-0.02, 0.05) for _ in range(10)]
            }
    ...
    def demonstrate_tagging_system(self):
        ...
        strategies = [
            {"id": "BTC_MOMENTUM", "profit": 0.023, "confidence": 0.85},
            {"id": "ETH_SCALP", "profit": 0.015, "confidence": 0.72},
            {"id": "USDC_ARBITRAGE", "profit": 0.008, "confidence": 0.91},
            {"id": "SOL_SWING", "profit": -0.012, "confidence": 0.45},
            {"id": "BTC_HODL", "profit": 0.031, "confidence": 0.78}
        ]
    ...
    def show_profit_gradient_tracking(self):
        ...
        for i in range(time_steps):
            if i < 5:  # Growth phase
                ...
                change = np.random.uniform(-0.03, 0.06)
            elif i < 15:  # Decline phase
                change = np.random.uniform(-0.04, 0.01)
            else:  # Recovery phase
                change = np.random.uniform(-0.01, 0.04)
        ...
        if INTEGRATION_AVAILABLE:
            ...
            for tick in range(6):  # 6 ticks over 30 seconds
                ...
                strategy_performance = {
                    ...
                    'profit_history': [np.random.uniform(-0.01, 0.03) for _ in range(5)]
                }
