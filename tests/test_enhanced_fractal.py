...
from core.enhanced_fractal_core import (  # noqa: F401
    EnhancedFractalCore,
    QuantizationProfile,
    FractalState
)
...
class TestEnhancedFractalCore(unittest.TestCase):
    ...
    def test_forever_fractal(self):
        ...
        self.assertNotEqual(
            signal,
            shifted
        )  # Different phase should give different signal
    ...
    def test_generate_fractal_vector(self):
        ...
        # All components bounded
        self.assertTrue(all(-1 <= v <= 1 for v in vector))
    ...
    def test_process_recursive_state(self):
        ...
        vector = [0.0] * 8
        _ = self.core.process_recursive_state(vector)  # noqa: F841
    ...
    def test_state_persistence(self):
        ...
        # Compare states
        self.assertEqual(
            len(self.core.state_history),
            len(loaded_core.state_history)
        )
        self.assertEqual(self.core.dormant_state, loaded_core.dormant_state)
        self.assertEqual(
            self.core.last_profit_snapshot,
            loaded_core.last_profit_snapshot
        )
