...
class TestShiftPatternEngine:
    ...
    def test_api_penalty_decay(self, engine):
        ...
        penalized_tau5 = engine.compute_api_penalty_decay(confidence, error_count, tau=5.0)
        penalized_tau20 = engine.compute_api_penalty_decay(confidence, error_count, tau=20.0)
    ...
    def test_time_lock_phase_drift(self, engine):
        ...
        drift_magnitude_aligned, drift_direction_aligned = engine.compute_time_lock_phase_drift(
            0.5, 0.5, 0.5
        )
        ...
        drift_magnitude_test, drift_direction_test = engine.compute_time_lock_phase_drift(
            0, 1.0, 0.5
        )
