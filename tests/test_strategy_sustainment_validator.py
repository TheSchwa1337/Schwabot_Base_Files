...
from core.strategy_sustainment_validator import (  # noqa: F401)
...
class TestStrategySustainmentValidator(unittest.TestCase):
    ...
    def test_excellent_strategy_validation(self):
        ...
        _ = self.validator.validate_strategy(  # noqa: F841
            excellent_metrics,
            "excellent_strategy\""
        )
        ...
        for principle, score in result.principle_scores.items():
            ...
            self.assertGreater(
                score.score,
                0.7,
                f"{principle.value} score too low\""
            )
    ...
    def test_principle_weights_impact(self):
        ...
        _ = self.validator.validate_strategy(base_metrics)  # noqa: F841

        # Weighted score should be higher than unweighted due to high
        # transcendence
        # (transcendence has weight 2.0, so high score there boosts weighted
        # average)
    ...
    def test_critical_principle_failure(self):
        ...
        _ = self.validator.validate_strategy(metrics_bad_survivability)  # noqa: F841
    ...
    def test_adaptive_threshold_adjustment(self):
        ...
        # Adjust threshold
        new_threshold = 0.80
        self.validator.adjust_thresholds(
            SustainmentPrinciple.ECONOMY,
            new_threshold
        )

        self.assertEqual(
            self.validator.principle_thresholds[SustainmentPrinciple.ECONOMY],
            new_threshold
        )
        ...
        self.assertEqual(
            self.validator.principle_weights[SustainmentPrinciple.ECONOMY],
            new_weight
        )
    ...
    def test_quick_validation_function(self):
        ...
        _ = validate_strategy_quick(  # noqa: F841
    ...
    def test_confidence_integration(self, mock_confidence_engine):
        ...
        metrics = StrategyMetrics(entropy_coherence=0.8,
                                  profit_efficiency=0.8,
                                  drawdown_resistance=0.8,
                                  emergent_signal_score=0.7,
                                  **{attr: 0.7 for attr in ['system_harmony',
                                                            'module_alignment',
                                                            'lead_time_prediction',
                                                            'pattern_recognition_depth',
                                                            'signal_forecast_accuracy',
                                                            'adaptation_speed',
        ...
        _ = validator.validate_strategy(metrics)  # noqa: F841
    ...
    def test_fractal_integration_scoring(self):
        ...
        # For testing, we verify the scoring logic handles missing/mock data
        # gracefully
        ...
        _ = self.validator.validate_strategy(metrics)  # noqa: F841
    ...
    def test_recommendation_generation(self):
        ...
        _ = self.validator.validate_strategy(weak_responsiveness_metrics)  # noqa: F841
...
class TestIntegrationWithExistingSystems(unittest.TestCase):
    ...
    def test_strategy_metrics_from_real_data(self):
        ...
        strategy_metrics = StrategyMetrics(
            ...
            signal_forecast_accuracy= (
                mock_market_conditions['recent_profit_correlation'],
            )
            ...
            profit_efficiency=mock_tick_signature.signal_strength *
            mock_market_conditions['profit_tier_success_rate'],
            ...
            risk_adjusted_return=mock_tick_signature.signal_strength *
            (1.0 - mock_market_conditions['volatility']),
            volatility_tolerance=min(
                1.0 - mock_market_conditions['volatility'],
                1.0)
            ),
            ...
            emergent_signal_score=mock_tick_signature.signal_strength *
            mock_tick_signature.correlation_score,
