...
from core.strategic_dormancy import StrategicDormancy
...
class TestRecursiveAwareness(unittest.TestCase):
    ...
    def test_euler_based_triggers(self):
        ...
        result = self.fractal_core.process_recursive_state(vector)
        ...
        post_euler_field = self.fractal_core.compute_post_euler_field(result['euler_phase'])
    ...
    def test_memory_decay(self):
        ...
        while current_time < end_time:
            ...
            self.assertAlmostEqual(
                ...
                places=6,
                msg="Confidence decay does not match expected exponential decay"
            )
