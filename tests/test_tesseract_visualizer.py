...
class TestTesseractVisualizer(unittest.TestCase):
    ...
    def test_4d_to_3d_projection(self):
        ...
        slice_proj = self.visualizer._project_4d_to_3d(test_tensor, method='slice')
        ...
        avg_proj = self.visualizer._project_4d_to_3d(test_tensor, method='average')
        self.assertEqual(avg_proj.shape, (5, 5, 5))
        
        # Test invalid method
        invalid_proj = self.visualizer._project_4d_to_3d(test_tensor, method='invalid')
    ...
    def test_history_management(self):
        ...
        self.assertLessEqual(len(self.visualizer.metrics_history), self.visualizer.history_size)
        self.assertLessEqual(len(self.visualizer.pattern_history), self.visualizer.history_size)
        self.assertLessEqual(len(self.visualizer.projection_history), self.visualizer.history_size)
