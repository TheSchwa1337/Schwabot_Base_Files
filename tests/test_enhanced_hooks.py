...
Tests for the enhanced hook system with thermal-aware, profit-synchronized routing.
"""
...
def test_enhanced_hooks_import():
    """Test that enhanced hooks can be imported without errors"""
    try:
        from core.enhanced_hooks import DynamicHookRouter, HookState, HookContext
        assert True
...
def test_hook_system_manager_initialization():
    ...
    try:
        from core.hooks import HookSystemManager
...
""")
        ...
        try:
            ...
            assert hasattr(context, 'thermal_zone') or 'thermal_zone' in context
...
def test_legacy_hook_compatibility():
    ...
    try:
        from core.hooks import ncco_manager, sfsss_router, cluster_mapper
        from core.hooks import drift_engine, echo_logger, vault_router
        from core.hooks import execute_hook, get_hook_context, get_hook_stats
        
        # Test that legacy variables are available (may be None if components not available)
...
def test_hook_execution():
    ...
    try:
        from core.hooks import execute_hook, HookSystemManager
        ...
        # Test execution
        result = manager.execute_hook("test_hook", "test_method", "arg1", kwarg1="kwarg1")
...
def test_hook_context_structure():
    ...
    try:
        from core.hooks import get_hook_context
...
def test_hook_configuration_loading():
    ...
    try:
        from core.enhanced_hooks import DynamicHookRouter
...
def test_hook_execution_conditions(thermal_zone, profit_zone, expected):
    ...
    try:
        from core.enhanced_hooks import DynamicHookRouter, HookContext
        ...
        should_execute, reason = router.should_execute_hook("sfsss_router", context)
...
def test_hook_performance_tracking():
    ...
    try:
        from core.enhanced_hooks import DynamicHookRouter, HookPerformance
