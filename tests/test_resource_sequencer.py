...
from core.resource_sequencer import ResourceSequencer, ResourceState, ResourceMetrics, SequenceMetrics
...
class TestResourceSequencer(unittest.TestCase):
    ...
    def test_calculate_position_size(self):
        # Test optimal state
        with patch.object(self.sequencer, 'get_resource_metrics') as mock_metrics:
    ...
    def test_optimal_sequence_params(self):
        ...
        self.assertEqual(params['position_size'], self.sequencer.base_position_size)
