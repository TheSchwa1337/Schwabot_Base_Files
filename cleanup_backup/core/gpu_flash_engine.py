...
class GPUFlasherEngine:
    ...
    def process_flash(self, market_data: Dict[str, Any], context: str = "normal") -> FlashAnalysisResult:
        ...
        try:
            ...
            logger.info(
                f"Flash processing completed: {flash_id} (coherence: {coherence_score:.3f}, risk: {risk_level})")
            return result
    ...
    def analyze_entropy_cascade(self) -> Optional[EntropyCascade]:
        ...
        try:
            ...
            logger.info(
                f"Entropy cascade analyzed: {cascade_id} (depth: {cascade_depth}, stability: {stability_score:.3f})")
            return cascade
