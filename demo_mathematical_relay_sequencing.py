    ...
    def demo_btc_price_hash_sequencing(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if successful_results:
                ...
                print(f"   Successful scenarios: {len(successful_results)}/{len(btc_scenarios)}")
                print(f"   Average duration: {avg_duration:.6f}s")
                print(f"   Success rate: {len(successful_results)/len(btc_scenarios)*100:.1f}%")
    ...
    def demo_bit_depth_switching(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if successful_results:
                ...
                print(f"   Successful switches: {len(successful_results)}/{len(bit_depth_scenarios)}")
                print(f"   Average duration: {avg_duration:.6f}s")
                print(f"   Success rate: {len(successful_results)/len(bit_depth_scenarios)*100:.1f}%")
    ...
    def demo_profit_optimization(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if successful_results:
                ...
                print(f"   Successful optimizations: {len(successful_results)}/{len(profit_scenarios)}")
                print(f"   Average duration: {avg_duration:.6f}s")
                print(f"   Success rate: {len(successful_results)/len(profit_scenarios)*100:.1f}%")
    ...
    def demo_time_log_analysis(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if "error" in statistics:
                ...
                return {"type": "time_log_analysis", "error": statistics["error"], "success": False}
            ...
            return {"type": "time_log_analysis", "statistics": statistics, "success": True}
        ...
        for demo_name, demo_func in demos:
            ...
            try:
                ...
                if result.get("success", False):
                    ...
                    print(f"❌ {demo_name} failed: {result.get('error', 'Unknown error')}")
    ...
    def print_demo_summary(self):
        ...
        for result in self.demo_results:
            ...
            if success and "results" in result:
                ...
                print(f"   {status} {demo_type}: {successful_results}/{total_results} scenarios")
            else:
        ...
        if self.sequencer:
            ...
            if "error" not in final_stats:
                ...
                if type_dist:
                    ...
                    print(f"   Most common sequence: {most_common[0]} ({most_common[1]} times)")
