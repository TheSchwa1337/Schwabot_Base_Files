...
dummy_weather1 = {"timeframe": "1h", "price_gradient": 0.1, "fourier_amplitude": 5.0, "timestamp": "2024-1-1T10:0:0"}
dummy_weather2 = {"timeframe": "4h", "price_gradient": -0.5, "fourier_amplitude": 12.0, "timestamp": "2024-1-1T11:0:0"}
dummy_weather3_old = {"timeframe": "1d", "price_gradient": 0.2, "fourier_amplitude": 8.0, "timestamp": "2023-1-1T12:0:0"}
...
dummy_path1 = MockCausalPathway("path_abc_123", 0.15, pd.Timestamp("2024-1-1T10:5:0").timestamp())
dummy_path2 = MockCausalPathway("path_xyz_456", -0.2, pd.Timestamp("2024-1-1T11:10:0").timestamp())
dummy_path3_old = MockCausalPathway("path_old_789", 0.8, pd.Timestamp("2023-1-1T12:15:0").timestamp())
