# -*- coding: utf - 8 -*-
"""Entropy flattener \\u2013 smooths strategy response during uncertain conditions."""Entropy flattener \\u2013 smooths strategy response during uncertain conditions.""
# -*- coding: utf - 8 -*-
...
signal: Sequence[float],
    price_sigma: float,
        *,
        epsilon: float = 1e - 9,
        ) -> float:  # noqa: D401"""Return \\u03b7(t) entropy flattening coefficient \\u2208 [0, 1].""""
...
current_value: float,
    smoothed_value: float,
        ...
        *,
        alpha: float = 0.1,
        ) -> float:  # noqa: D401"""Apply entropy - weighted smoothing between current and smoothed values.""""
