...
from matrix_mapper import BitPhase, MatrixMapper
...
def get_entries_by_priority_range(self):
    """Function implementation pending."""
...
def get_best_matching_hash(self, bit_depth: int, tensor_route: str = None,):
...
entry.hash_id}_{
    entry.bit_depth}_{
        entry.tensor_route}_{
            entry.matrix_basket_id}_{
                entry.priority}""
