# -*- coding: utf - 8 -*-
"""Ghost strategy matrix utilities."""Ghost strategy matrix utilities.""
# -*- coding: utf - 8 -*-
...
P: np.ndarray,
    delta_G: np.ndarray,
        zeta: np.ndarray,
        ) -> np.ndarray:  # noqa: D401"""Return element - wise product R = P * delta_G * zeta.""""
...
Q: np.ndarray,
    T: np.ndarray,
        lam: np.ndarray,
        ) -> int:  # noqa: D401"""Return strategy index i that maximises softmax(Q * T * lam)."""
""""""
