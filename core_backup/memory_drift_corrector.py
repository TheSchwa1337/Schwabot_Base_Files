# -*- coding: utf - 8 -*-
"""Memory - drift corrector \\u2013 detect glyph hash drift and decide re - link."""Memory - drift corrector \\u2013 detect glyph hash drift and decide re - link.""
# -*- coding: utf - 8 -*-
...
prev_hash: str,
    curr_hash: str,
        ...
        ) -> float:"""Return softmax - based drift score in [0,1]."""
""""""
...
) -> bool:  # noqa: D401"""TODO: document relink_required."""
""""""
