...
if __name__ == "__main__":
    ...
    example_metrics = {
        ...
        "max_drawdown_percent": 0.5,  # Survivability
        "crwm_stability_score": 0.9,  # Survivability
        "memory_coherence_index": 0.95,  # Continuity
        "fractal_cohesion_score": 0.88,  # Continuity
        "psi_score_improvement": 0.2,  # Transcendence
        "emergent_adaptation_rate": 0.15,  # Transcendence
}
}
    ...
    failing_metrics = {
        ...
        "psi_score_improvement": -0.1,  # Negative improvement
        "emergent_adaptation_rate": 0.1,  # Low adaptation
}
}
