...
thermal_conductivity: Union[float, ThermalConductivity] = 0.24,
...
def __init__(self, dimensions: Tuple[int, int] = (256, 256)) -> None:"""Function implementation pending.""":
""""""
""""""
...
Implements: G(x,y) = 1/(1 + exp(-H(x,y)))
