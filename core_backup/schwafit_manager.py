...
if __name__ == "__main__":
    ...
    schwafit_mgr = SchwafitManager(min_ratio=0.1, max_ratio=0.3, ferris_cycle_period=50, noise_scale=0.5)
    ...
    for i in range(5):
        ...
        if holdout_data:
            ...
            schwafit_mgr.variance_pool.update(dummy_variance, variance_consumed=0.1)  # Simulate some consumption
