...
class EntryExitPortalSystem:
    ...
    def __init__(self, initial_capital: float = 10000.0, risk_per_trade: float = 0.2, enable_hourly_sync: bool = True):
        """"""
    ...
    def _calculate_risk_parameters()
        ...
        try:
            ...
            risk_multipliers = {}
                RiskLevel.CONSERVATIVE: (0.2, 0.4),  # 2% stop loss, 4% take profit
                RiskLevel.MODERATE: (0.3, 0.6),  # 3% stop loss, 6% take profit
                RiskLevel.AGGRESSIVE: (0.5, 0.10),  # 5% stop loss, 10% take profit
                RiskLevel.EXTREME: (0.8, 0.15),  # 8% stop loss, 15% take profit
}
            ...
            return price * 0.98, price * 1.2  # Default 2% range
...
def initialize_portal_system()
    initial_capital: float = 10000.0, risk_per_trade: float = 0.2, enable_hourly_sync: bool = True
...
def main():
    ...
    try:
        ...
        portal = initialize_portal_system(initial_capital=10000.0, risk_per_trade=0.2, enable_hourly_sync=True)
