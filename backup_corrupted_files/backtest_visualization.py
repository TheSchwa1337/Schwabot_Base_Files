...
def _plot_portfolio_value(self,   ax, portfolio_history: List[float]) -> None:
...
def _plot_trade_distribution(self,   ax, trades_df: pd.DataFrame) -> None:
...
def _plot_drawdown(self,   ax, portfolio_history: List[float]) -> None:
...
def create_trade_analysis(self,   trade_history: List[Dict], save: bool = True) -> None:
...
def _plot_trade_volume(self,   ax, trades_df: pd.DataFrame) -> None:
...
def _plot_trade_sizes(self,   ax, trades_df: pd.DataFrame) -> None:
...
def _plot_win_loss(self,   ax, trades_df: pd.DataFrame) -> None:
...
def _plot_profit_factor(self,   ax, trades_df: pd.DataFrame) -> None:
...
def save_trade_log(self,   trade_history: List[Dict]) -> None:
