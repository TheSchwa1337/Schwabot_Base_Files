...
start_time = time.time()
    ...
    # Check if CUDA is available
        ...
        logger.info("🎯 Profit optimization: Adaptive switching to CPU-based strategy execution for {0}".format(task_id))
...
Args:
data: Dictionary containing probability distribution

Returns:
Dictionary with entropy calculation results
"""
    try:
