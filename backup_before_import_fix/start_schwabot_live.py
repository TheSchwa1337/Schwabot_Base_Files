...
async def check_system_requirements():
    ...
    config_files = ["config/schwabot_live_trading_config.yaml", "config/schwabot_config.yaml"]
...
async def main():
    ...
    parser.add_argument(
        "--mode", choices=["demo", "live", "backtest"], default="demo", help="Trading mode (default: demo)"
    )
    parser.add_argument("--config", default="config/schwabot_live_trading_config.yaml", help="Configuration file path")
