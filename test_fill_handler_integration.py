...
class FillHandlerIntegrationTest:
    ...
    async def test_partial_fill_handling(self):
        ...
        order_state = OrderState(
            ...
            side="buy",
            order_type="market",
            original_amount=Decimal("0.01")  # 0.01 BTC
        )
    ...
    async def test_order_state_management(self):
        ...
        fills = [
            {"qty": "0.3", "price": "3000.00", "commission": "0.0009", "tradeId": "fill_1"},
            {"qty": "0.4", "price": "3001.00", "commission": "0.0012", "tradeId": "fill_2"},
            {"qty": "0.3", "price": "3002.00", "commission": "0.0009", "tradeId": "fill_3"}
        ]
        ...
        try:
            ...
            assert abs(float(final_order.average_price) - expected_avg_price) < 0.01, \
